...
import 'package:Food_ordering/base/custom_button.dart';
...
import 'package:Food_ordering/models/address_model.dart';
import 'package:Food_ordering/uitls/app_dimensions.dart';
import 'package:Food_ordering/uitls/styles.dart';
      ...
      body: SafeArea(child: Center(child: SizedBox(
        ...
        child: GetBuilder<LocationController>(builder: (locationController) {
          ...
          return Stack(children: [
            ...
            Center(child: !locationController.loading ? Image.asset("assets/image/pick_marker.png", height: 50, width: 50)
